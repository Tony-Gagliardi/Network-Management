...
Goal 3 - Modify the tool for preventing attacks in a network with dynamically assigned IP Addresses (eg. An internal DHCP Server).
    ...
    This goal is still in progress because of limitations of mininet. I can't seem to find a way to get mininet hosts to talk to a DHCP server to obtain their IP Addresses. If I had that working, I have a very specific strategy for completing this goal.
